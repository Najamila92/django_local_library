# Generated by Django 4.2.14 on 2024-07-29 08:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('death_of_death', models.DateField(blank=True, null=True, verbose_name='Died')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter a New Language', max_length=100, unique=True)),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.AddField(
            model_name='book',
            name='language',
            field=models.ForeignKey(help_text='Select a Language the book was written in', on_delete=django.db.models.deletion.RESTRICT, to='catalog.language'),
        ),
    ]
